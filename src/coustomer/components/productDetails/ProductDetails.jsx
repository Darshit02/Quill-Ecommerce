      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-md max-w-[30rem] max-h-[35rem]">
              <img
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px=6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                Casual fit for all day comfort. Made with 100% cotton. Soft and
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center gap-4">
                  ...
                  <p className="opacity-50 text-sm">454 Ratings</p>
                  <p className="ml-3 text-sm font-medium text-blue-500 hover:text-blue-600">
                    33 Reviews
                  </p>
                </div>
              </div>
        ...
        <section className="flex flex-col justify-center  mt-2">
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="text-xl font-semibold pb-1">Rating Overview</h1>
                <div className="flex items-center space-x-2">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">2345 Ratings</p>
                </div>
                <Box className="mt-5">
                  <Grid
                    container
        ...
        {/* similar products */}
        <section className="pt-10 ml-10 flex justify-center gap-4 flex-col">
          <h1 className=" py-5 text-2xl font-bold">Similar Products</h1>
          <div className="flex items-center justify-center flex-wrap space-y-5">
            {kurta.map((item) => (
