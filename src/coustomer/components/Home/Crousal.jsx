        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                <span className="block xl:inline">Your Dream styles are finally Here.</span>
            </h1>
          ...
          <div>
            <div className="mt-10">
              ...
              <a
                href="#"
                className=" flex justify-center items-center gap-2 w-[15rem] rounded-md border border-transparent bg-blue-600 px-8 py-3 text-center font-medium text-white hover:bg-blue-700"
              >
                Shop Collection
